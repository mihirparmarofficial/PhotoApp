...
@interface AppDelegate () <UNUserNotificationCenterDelegate>  // Conform to UNUserNotificationCenterDelegate
@end
...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
  ...
  // Register for remote notifications
  [UNUserNotificationCenter currentNotificationCenter].delegate = self;  // Set delegate
  [application registerForRemoteNotifications];
